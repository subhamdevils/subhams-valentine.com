  ...
  if (button.textContent === "Click Me! ❤") {
    ...
    fetch("send_mail.php")
      ...
      .catch((error) => {
        ...
        button.textContent = "no worry i will love u until my last breatgh 😞";
      });
  }
});
...
function drawText() {
  ...
  if (frameNumber < 300) {
    ...
    context.fillText(
      "Dibyajeet:everyday day I cannot believe how lucky I am",
      canvas.width / 2,
      canvas.height / 2
    );
  ...
  if (frameNumber > 600 && frameNumber < 900) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        ["Dibyajeet:amongst trillions and trillions of stars,", "over billions of years"],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
        lineHeight
  ...
  if (frameNumber > 2400 && frameNumber < 2700) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "Dibyajeet:and yet here I am to get the impossible",
      ...
      context.fillText(
        "Dibyajeet:and yet here I am to get the impossible chance to get to know you",
        canvas.width / 2,
        canvas.height / 2
      );
    }
  ...
  if (frameNumber > 3000 && frameNumber < 99999) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "Dibyajeet:I love you so much , more than",
      ...
      context.fillText(
        "Dibyajeet:I love you so much , more than all the time and space in the universe can contain",
        canvas.width / 2,
        canvas.height / 2
      );
    }
